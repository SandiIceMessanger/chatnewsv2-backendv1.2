...
type (
	Post struct {
		...
		Pubdate string `json:"date" bson:"date"`
		// Link      string             `json:"link" bson:"link"`
		Link      string        `json:"url" bson:"url"`
		CreatorId bson.ObjectId `json:"creator_id" bson:"creator_id"`
		// Creator     []DataUserActivity `json:"creator" bson:"creator"`
		// Creator     []DataAuthorActivity `json:"creator" bson:"creator"`
		...
		Category []uint        `bson:"categories"  json:"categories"`
		Tag      []uint        `bson:"tags"  json:"tag"`
